...
in the application base directory, including fizzbuzz.exe, jaunch.exe,
jaunch.toml, fizzbuzz.toml, and Props.class. It would be nice if there was an
option to nest these into a common subfolder such as jaunch or .jaunch.
