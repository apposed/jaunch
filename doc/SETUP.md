...
1. OPTION 1: Download and unpack the
   ...
   The rest of this guide will assume you unpacked the Jaunch v2.0.2
   release into your home directory at `~/jaunch-2.0.2`.
...
1. Optionally, compress the launcher executables using
   `~/jaunch-2.0.2/bin/pack.sh`, which uses [UPX](https://upx.github.io/) to
...
2. Code-sign your macOS and/or Windows binaries using
   `~/jaunch-2.0.2/bin/sign.sh`. See these guides for detailed instructions:
