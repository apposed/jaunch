...
1. OPTION 1: Download and unpack the
   ...
   The rest of this guide will assume you unpacked the Jaunch v2.1.1
   release into your home directory at `~/jaunch-2.1.1`.
...
1. Optionally, compress the launcher executables using
   `~/jaunch-2.1.1/bin/pack.sh`, which uses [UPX](https://upx.github.io/) to
